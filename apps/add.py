...
data_base_model: Any = model_factory.database_model
...
layout = html.Div(
    children=[
        ...
        html.Form(
            children=[
                html.Div(
                    className="form-group float-left col-xs-12 col-sm-6 col-md-4 col-lg-4",
                    children=[
                ...
                html.Div(
                    className="form-group float-left col-xs-3 col-sm-6 col-md-4 col-lg-4",
                    children=[
                        html.Label("Store"),
                        html.Button(
...
def update_data_graph(n_clicks, fish_type, river_id, fisher_id, catch_date, catch_hour):
    ...
    if n_clicks and fish_type and river_id and fisher_id and catch_date and catch_hour:
        ...
        correct_store = data_base_model.add_fish(
            fish_type=fish_type,
            fisher_id=fisher_id,
            river_id=river_id,
