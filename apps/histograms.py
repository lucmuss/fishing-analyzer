...
fish_options = generate_fish_options()
...
default_y_values, default_x_values = utils.series_to_graph(default_data_series)
...
def update_data_graph(fish_type, attribute_name):
    ...
    y_values, x_values = utils.series_to_graph(data_series)
