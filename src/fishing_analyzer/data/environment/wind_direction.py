...
class WindDirection(BaseAttribute):
    """Repräsentiert die Windrichtungsdaten, abgeleitet von BaseAttribute."""

    file_location: str = "raw_data/wind_strength/produkt_ff_stunde_19490101_20171231_00282.txt"
    attribute_name: str = "wind_direction"
    ...
    def __read(self) -> None:
        """Liest die Windrichtungsdaten aus der CSV-Datei und füllt data_dict."""
        ...
        with open(self.abs_file_location, newline="", encoding="utf-8") as csv_file:
            ...
            for row_raw in csv_reader:
                ...
                station, date_str, _, _, direction_str, _ = row
                ...
                if utils.has_correct_year_range(date_str) and utils.validate_row(row_raw, station):  # type: ignore
                    try:
                        ...
                        wind_direction: float = float(direction_str)
