...
class RecordDateHour(BaseAttribute):
    """Repräsentiert den Datums- und Stundenstempel der Aufzeichnungen, abgeleitet von BaseAttribute."""

    file_location: str = 'raw_data/relativ_humidity_air_temperature/produkt_tu_stunde_19490101_20171231_00282.txt'
    attribute_name: str = 'record_date_hour'
    ...
    def __read(self) -> None:
        """Liest die Datums- und Zeitstempel aus der CSV-Datei und füllt data_dict."""
            ...
            for row_raw in csv_reader:
                ...
                if utils.has_correct_year_range(date_str) and utils.validate_row(row_raw, station):
                    try:
                        ...
                        self.data_dict[formatted_string] = formatted_string
