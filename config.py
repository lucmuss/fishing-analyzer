...
def get_color_dict(attribute_list: list[str]) -> dict[str, tuple[int, int, int]]:
    ...
    color_list_rgb = [
        ...
        for h in colorlover.to_rgb(color_list_hex)
    ]
...
WORKING_DICTIONARY: str = os.getcwd()

FISH_DATA_CSV_LOCATION: str = OS_SEPARATOR.join([WORKING_DICTIONARY, "data", "fish_database.csv"])
